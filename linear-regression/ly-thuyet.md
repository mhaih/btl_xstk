...
* **Tính độc lập:** Các sai số $\varepsilon_i$ là độc lập.
...
Dùng để kiểm tra giả định về phân phối chuẩn của dữ liệu.
* $H_0$: Phần dư tuân theo phân phối chuẩn.
* $H_1$: Phần dư không tuân theo phân phối chuẩn.
Bác bỏ $H_0$ nếu $p\text{-value} < \alpha$.

**Kết luận:** Nếu bác bỏ $H0$, dữ liệu không có phân phối chuẩn.
